...
import com.aurionpro.test.Builder;
import com.aurionpro.test.Guitar;
import com.aurionpro.test.GuitarSpec;
import com.aurionpro.test.Inventory;
import com.aurionpro.test.Type;
import com.aurionpro.test.Wood;
...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
		...
		GuitarSpec whatashishLikes = new GuitarSpec(Builder.COLLINGS, "CJ", Type.ELECTRIC, 6, Wood.ALDER, Wood.ALDER);

		List matchingGuitars = inventory.search(whatErinLikes);

		List matchingGuitars1 = inventory.search(whatashishLikes);

		matchingGuitarsInventory(matchingGuitars);

		matchingGuitarsInventory(matchingGuitars1);
...
//		}
	...
	private static void matchingGuitarsInventory(List matchingGuitars) {
